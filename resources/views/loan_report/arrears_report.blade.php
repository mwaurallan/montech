        ...
        <div class="panel panel-white">
            <div class="panel-body table-responsive no-padding">
                ...
                <table class="table table-bordered table-condensed table-hover ">
                    ...
                    ?>
                    @foreach(\App\Models\Loan::where('first_payment_date','<=',$end_date)->where('status', 'disbursed')->orderBy('release_date','asc')->get() as $key)
                        <?php
                        ...
                        $totalOutstandingInterest = $totalOutstandingInterest + $outstandingInterest = $interest - $loan_paid_items['interest'];
                        $totalOutstandingPrincipal = $totalOutstandingPrincipal + $outstandingPrincipal= $principal - $loan_paid_items['principal'];
                        if ($due > 0) {
                        ...
                        @if($due >0)
                            <tr>
                                ...
                                <td>{{ number_format($outstandingPrincipal,2) }}</td>
                    ...
                    <tr>
                        ...
                        <th>{{ number_format($totalOutstandingPrincipal,2) }}</th>
                        <th>{{ number_format($totalOutstandingInterest,2) }}</th>
