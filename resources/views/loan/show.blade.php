                        ...
                        <div class="col-md-3 form-horizontal">
                            <div class="form-group">
                                <label class="control-label col-md-4"><strong>{{trans_choice('general.age',1)}}
                                        :</strong></label>
                                <div class="col-md-8" style="padding-top: 9px;">
                                    <span>{{number_format(((time()-strtotime($loan->borrower->dob))/365/24/60/60),2)}} {{trans_choice('general.year',2)}}</span>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <!-- /.tab-pane -->
                            <div class="tab-pane " id="transactions">
                                <div class="btn-group-horizontal">
                                    @if(Sentinel::hasAccess('repayments.create') && ( $loan->status=="disbursed" ))
                            ...
                            <div class="modal fade" id="addInterest">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        {!! Form::open(array('url' => url('loan/'.$loan->id.'/add_interest'),'method'=>'post')) !!}
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    ...
                                                    @if(Sentinel::hasAccess('loans.update'))
                                                        <li>
                                                            <a href="#" class=""
                                                               data-toggle="modal"
                                                               data-target="#addInterest">Add Interest</a>
                                                        </li>
                                                        <li>
                                                            <a href="#" class=""
                                                               data-toggle="modal"
                            ...
                            <div class="box box-success">
                                <div class="table-responsive">
                                    <table id="data-table" class="table table-bordered table-condensed table-hover">
                                        ...
                                        <tbody>
                                        @php $loans =$loan->guarantors @endphp
                                        @foreach($loan->guarantors as $key)
                                            @if(!empty($key->guarantor))
                                                <tr>
                                                    ...
                                                    <td>{{ number_format($key->amount_guaranteed) }}</td>
                                                    <td>
                                                        <div class="btn-group">
                                                            <button type="button"
                                                                    class="btn btn-info btn-xs dropdown-toggle"
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                                                ...
                                                                @if(Sentinel::hasAccess('loans.guarantor.delete'))
                                                                    <li>
                                                                        <a href="{{ url('loan/guarantor/'.$key->id.'/remove') }}"
                                                                           class="delete"><i
...
{{--                                                                @endif--}}
                                        ...
                                        <tr>
                                            ...
                                            <th>{{ number_format($loan->guarantors->sum('amount_guaranteed')) }}</th>
                                            <th></th>
                                        </tr>
                                        </tbody>
                                    </table>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            ...
                            {!! Form::text('first_payment_date',$loan->first_payment_date,array('class'=>'form-control date-picker',''=>'','required'=>'required','autocomplete' => 'off')) !!}
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-line">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <label>Amount To Guarantee</label>
                            <input type="number" class="form-control" required name="amount_guaranteed">
                        </div>
