...
Route::get('client', 'HomeController@clientLogin')->name('client_login');
...
Route::get('dashboard','DashboardController@index')->middleware(['sentinel','branch']);
...
Route::group(['prefix' => 'borrower'], function () {
    ...
    Route::resource('memberVehicles', 'MemberVehicleController');
});
...
Route::group(['prefix' => 'loan'], function () {
    ...
    Route::post('process-loan-repayment','LoanController@processFieldRepayment');
    Route::get('getMemberLoans/{id}','LoanRepaymetReceiptController@getReceipt');
    ...
    Route::post('{id}/approve', 'LoanController@approve')->name("loan.approve");
    Route::get('{id}/approve', 'LoanController@showApprove')->name("loan.approve.view");
    ...
    Route::post('{loan}/add_interest', 'LoanController@addInterest');
    ...
    Route::get('loan_application/{id}/disburse', 'LoanController@disburseView');
    ...
    Route::resource('loanRepaymetReceipts', 'LoanRepaymetReceiptController');
});
//loan repayment list
...
Route::group(['prefix' => 'report'], function () {
    Route::any('cumulativeReport', 'ReportController@cumulativeReport');
    Route::any('outstandingReport', 'ReportController@outstandingPrincipal');
    Route::any('expensesReport', 'ReportController@expensesReport');
    Route::any('memberStatement','ReportController@memberStatement');
    Route::any('summaryMemberStatement','ReportController@summaryMemberStatement');
    Route::any('collectionReport','ReportController@collectionReport');
    ...
    Route::any('smsReport', 'ReportController@smsReport');
    Route::any('savings_report', 'ReportController@savings_report');
    Route::any('defaultersReport', 'ReportController@savingsDefaulters');
...
Route::get('re',function(){
    $max = (is_null($m = App\Models\SavingTransaction::orderByDesc('id')->first())) ? 0 : $m->receipt;
    $max2 = (is_null($m = App\Models\OtherIncome::orderByDesc('id')->first()))? 0 : $m->notes;
         // $max2 = App\Models\OtherIncome::orderByDesc('id')->first()->notes;
...
Route::group(['prefix' => 'communication'], function () {
    ...
    Route::get('resend/{id}','CommunicationController@resend');
...
Route::group(['prefix' => 'saving'], function () {
    ...
    //saving from field
//    Route::get('fieldSavingTransactionCreate', 'SavingTransactionController@fieldSavingTransactionCreate');
    Route::resource('fieldSavingTransactions', 'FieldSavingTransactionController');
...
Route::group(['prefix' => 'check_out'], function () {
    ...
    Route::get('{product}/get_product_data', 'ProductCheckoutController@get_product_data');
...
Route::group(['prefix' => 'chart_of_account'], function () {
    ...
    Route::get('chartOverView', 'ChartOfAccountController@chartOverView');
    Route::any('accountStatement', 'ReportController@accountStatement');
    Route::any('summaryAccountStatement', 'ReportController@summaryAccountStatement');
...
Route::group(['prefix' => 'template'], function () {
    ...
    Route::get('data', 'MessageTemplateController@index');
    Route::get('create', 'MessageTemplateController@create');
    Route::post('store', 'MessageTemplateController@store');
    Route::get('{charge}/show', 'MessageTemplateController@show');
    Route::get('{id}/edit', 'MessageTemplateController@edit');
    Route::post('{id}/update', 'MessageTemplateController@update');
    Route::get('{id}/delete', 'MessageTemplateController@delete');

});

Route::resource('saccos', 'SaccoController');

//mpesa payments
Route::any('getPaymentValidation',"MpesaController@getPaymentValidation");
Route::any('getPayment',"MpesaController@getPayment");
Route::get('registerUrls',"MpesaController@registerUrls");
Route::get('simulate',"MpesaController@simulate");


Route::any('importMembers','BorrowerController@importMembers');
Route::any('importVehicles','BorrowerController@importVehicles');

Route::get('getVehicles/{id}','MemberVehicleController@getVehicles');
Route::any('importTransactions','FieldSavingTransactionController@importTransactions');


//infobip
Route::get('smsBalance','OpenPathSmsController@getSmsBalance');
Route::post('purchaseCreditsStore','OpenPathSmsController@purchaseCreditsStore');
Route::post('stkSubmit','OpenPathSmsController@stkSubmit');


Route::resource('trips', 'TripController');


Route::resource('tripPayments', 'TripPaymentController');

Route::resource('payments', 'PaymentController');

Route::post('makePayment','CashlessController@makePayment');
...
Route::get('rec',function(){
    ...
    $receiptNumber = (is_null($receipt)? $re : ++$receipt->receipt);
    if(is_null($receipt)){
        $receiptNumber = $re;
...
Route::resource('processedMpesaPayments', 'ProcessedMpesaPaymentController');
Route::post('updateMpesa','MpesaPaymentController@update');
Route::resource('processedMpesaPayments', 'ProcessedMpesaPaymentController');
...
Route::get('trans',function(){
    return (new \App\Exports\Sales())->download('Quiver Lounge August 2021.xlsx');
});
