    ...
    <div class="panel panel-white">
        ...
        <div class="panel-body">
            <table id="" class="table table-striped table-hover">
                ...
                <tr>
                    <td>
                        <a href="{{url('report/cumulativeReport')}}">Cumulative Savings Report</a>
                    </td>
                    <td>
                        Cumulative savings/shares report
                    </td>
                    <td><a href="{{url('report/cumulativeReport')}}"><i class="icon-search4"></i> </a>
                    </td>
                </tr>
                <tr>
                    <td>
                        <a href="{{url('report/defaultersReport')}}">Defaulters Report</a>
                    </td>
                    <td>
                        Defaulter Report
                    </td>
                    <td><a href="{{url('report/defaultersReport')}}"><i class="icon-search4"></i> </a>
                    </td>
                </tr>
                <tr class="hidden">
                    <td>
