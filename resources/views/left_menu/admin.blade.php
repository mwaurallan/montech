            ...
            <div class="category-content no-padding">
                        ...
                        <li class="treeview @if(Request::is('borrower/*')) active @endif">
                            ...
                            <ul class="treeview-menu">
                                ...
                                @if(Sentinel::hasAccess('vehicles.view'))
                                    <li><a href="{{ url('borrower/vehicles') }}"><i
                                                    class="fa fa-circle-o"></i> Vehicles
                                        </a></li>
                                @endif
                                @if(Sentinel::hasAccess('memberVehicles.view'))
                                    <li><a href="{{ url('borrower/memberVehicles') }}"><i
                                                    class="fa fa-circle-o"></i> Member Vehicles
                                        </a></li>
                                @endif
                            </ul>
                        </li>
                ...
                @if(Request::is('loan/*')) active @endif
                    ...
                    @if(Sentinel::hasAccess('repayments'))
                        <li class="treeview @if(Request::is('repayment/*') || Request::is('mpesaPayments*') || Request::is('processedMpesaPayments*') ) active @endif">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">
                                ...
                                @if(Sentinel::hasAccess('mpesaPayments.view'))
                                    <li><a href="{{ url('mpesaPayments') }}"><i
                                                    class="fa fa-circle-o"></i> Unprocessed Mpesa Repayments
                                        </a></li>
                                @endif
                                @if(Sentinel::hasAccess('processedMpesaPayments.view'))
                                    <li><a href="{{ url('processedMpesaPayments') }}"><i
                                                    class="fa fa-circle-o"></i> Processed Mpesa Repayments
                                        </a></li>
                                @endif
                                ...
                                @endif
                                    ...
                                    <li><a href="{{ url('loan/loanRepaymetReceipts') }}"><i
                                                    class="fa fa-circle-o"></i> Field Loan Repayments
                                        </a></li>
                        ...
                        <li class="treeview @if(Request::is('saving/*')) active @endif">
                            ...
                            <ul class="treeview-menu">
                                ...
                                @if(Sentinel::hasAccess('fieldSavingTransactions.create'))
                                    <li><a href="{{ url('saving/fieldSavingTransactions/create') }}"><i
                                                    class="fa fa-circle-o"></i> Book New Receipt
                                        </a></li>
                                @endif

                                    <li><a href="{{ url('importTransactions') }}"><i
                                                    class="fa fa-circle-o"></i> Import Transactions
                                        </a></li>
                    ...
                    @endif
                        @if(Sentinel::hasAccess('capital'))
                            <li class="treeview">
                                <a href="#">
                                    <i class="fa fa-bank"></i> <span>{{trans_choice('general.capital',2)}}</span>
                                </a>
                                <ul class="treeview-menu">
                                    @if(Sentinel::hasAccess('capital.view'))
                                        <li><a href="{{ url('chart_of_account/data') }}"><i
                                                        class="fa fa-circle-o"></i> {{trans_choice('general.view',2)}}  {{trans_choice('general.chart_of_account',2)}}
                                            </a></li>
                                    @endif
                                    @if(Sentinel::hasAccess('capital.create'))
                                        <li><a href="{{ url('chart_of_account/create') }}"><i
                                                        class="fa fa-circle-o"></i> {{trans_choice('general.add',2)}} {{trans_choice('general.chart_of_account',1)}}
                                            </a></li>
                                    @endif
                                    @if(Sentinel::hasAccess('bank.view'))
                                        <li><a href="{{ url('capital/bank/data') }}"><i
                                                        class="fa fa-circle-o"></i> Banks
                                            </a></li>
                                    @endif
                                </ul>
                            </li>
                ...
                @if(Request::is('stock/*')) active @endif
                    ...
                    @if(Sentinel::hasAccess('reports'))
                        <li class="treeview @if(Request::is('report/*')) active @endif">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="{{ url('report/memberStatement') }}"><i
                                                class="fa fa-circle-o"></i> Member Statement
                                    </a></li>
                                <li><a href="{{ url('report/summaryMemberStatement') }}"><i
                                                class="fa fa-circle-o"></i>Summary Member Statement
                                    </a></li>

                                <li><a href="{{ url('report/expensesReport') }}"><i
                                                class="fa fa-circle-o"></i> Expenses Report
                                    </a></li>
                                <li><a href="{{ url('report/collectionReport') }}"><i
                                                class="fa fa-circle-o"></i> Collection Report
                                    </a></li>
                    ...
                    @if(Request::is('accounting/*')) active @endif
                        @if(Request::is('chart_of_account/*')) active @endif">
                            ...
                            <ul class="treeview-menu">
                                ...
                                @endif
                                    @if(Sentinel::hasAccess('repayments.view'))
                                        <li><a href="{{ url('chart_of_account/chartOverView') }}"><i
                                                    class="fa fa-circle-o"></i> Accounts Overview
                                            </a></li>
                                    @endif
                                    @if(Sentinel::hasAccess('repayments.view'))
                                        <li><a href="{{ url('chart_of_account/accountStatement') }}"><i
                                                    class="fa fa-circle-o"></i> Account Statement
                                            </a></li>
                                    @endif
                                    @if(Sentinel::hasAccess('repayments.view'))
                                        <li><a href="{{ url('chart_of_account/summaryAccountStatement') }}"><i
                                                    class="fa fa-circle-o"></i> Summary Account Statement
                                            </a></li>
                                    @endif
                    ...
                    @if(Sentinel::hasAccess('communication'))
                        ...
                        @if(Request::is('sms_gateway/*')) active @endif
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="{{ url('report/smsReport') }}"><i
                                            class="fa fa-circle-o"></i> Sms Report
                                    </a></li>
                                <li><a href="{{ url('template/data') }}"><i
                                                class="fa fa-circle-o"></i> Sms Templates
                                    </a></li>
                                @if(Sentinel::hasAccess('settings'))
                    ...
                    @endif
                    @if(Sentinel::hasAccess('cashless'))
                        <li class="treeview @if(Request::is('trips*') || Request::is('payments*') || Request::is('tripPayments*') ) active @endif">
                            <a href="#">
                                <i class="fa fa-users"></i> <span> Cashless Payments</span>
                            </a>
                            <ul class="treeview-menu">
                                @if(Sentinel::hasAccess('trips.view'))
                                    <li><a href="{{ url('trips') }}"><i class="fa fa-circle-o"></i> View Trips</a></li>
                                @endif
                                @if(Sentinel::hasAccess('trips.create'))
                                    <li><a href="{{ url('trips/create') }}"><i class="fa fa-circle-o"></i> Add Trip</a></li>
                                @endif
                                @if(Sentinel::hasAccess('payments.view'))
                                    <li><a href="{{ url('payments') }}"><i class="fa fa-circle-o"></i>All Payments</a></li>
                                @endif
                                @if(Sentinel::hasAccess('tripPayments.view'))
                                    <li><a href="{{ url('tripPayments') }}"><i class="fa fa-circle-o"></i>Trip Payments</a></li>
                                @endif
                            </ul>
                        </li>
                    @endif
