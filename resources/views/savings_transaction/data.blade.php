    ...
    <div class="panel panel-white">
        ...
        <div class="panel-body ">
            <div class="table-responsive">
                @include('savings_transaction.table')
...
--}}{{----}}{{--
                    ...
                    @foreach($data as $key)
                        <tr>
                            <td>{{$key->id}}</td>
                            <td>{{ (!is_null($key->borrower))? $key->borrower->first_name.' '.$key->borrower->last_name  : '' }}</td>
                            <td>{{ (!is_null($key->vehicle))? $key->vehicle->vehicle : '' }}</td>
                            <td>{{ (!is_null($key->savings))? $key->savings->savings_product->name : '' }}</td>
                            <td>{{$key->date}}</td>
