...
@section('content')
    <div class="panel panel-body login-form">
        ...
        <div class="text-center">
            <h3>{{ $name = App\Models\Setting::where('setting_key','company_name')->first()->setting_value }} </h3>
{{--            <h3>{{ \App\Models\Setting::where('setting_key','company_name')->first()->setting_value }}</h3>--}}
            <div class="icon-object border-slate-300 text-slate-300">
{{--                @if($name == 'RG Sacco')--}}
                    <img src="{{ url(asset('img/logo1.jpeg'))}}" class="" height="100"/>
{{--                @else--}}
{{--                <img src="{{ url(asset('uploads/logo.png'))}}" class="" height="72"/>--}}
{{--                @endif--}}
...
{{--                        {{ \App\Models\Setting::where('setting_key','welcome_note')->first()->setting_value }}--}}
