                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li>
                                    <a href="{{url('report/loan_report/disbursed_loans/pdf?start_date='.$start_date.'&end_date='.$end_date."&loan_product_id=".$loan_product_id)}}"
                                       target="_blank"><i
                                ...
                                <li>
                                    <a href="{{url('report/loan_report/disbursed_loans/csv?start_date='.$start_date.'&end_date='.$end_date."&loan_product_id=".$loan_product_id)}}"
                                       target="_blank"><i
...
{{--                <div class="row">--}}
                    <div class="">
                        <br>
                        <button class="btn btn-sm btn-info hidden-print pull-right" style="margin: 15px" onclick="window.print()">Print</button>
                    </div>
{{--                </div>--}}
            </div>
