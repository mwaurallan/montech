...
{{--                                    <span>{{date("Y-m-d") - $saving->borrower->dob}} {{trans_choice('general.year',2)}}</span>--}}
                                    <span>{{ \Carbon\Carbon::parse(\Carbon\Carbon::parse($saving->borrower->dob))->diffInYears(\Carbon\Carbon::today()) }} {{trans_choice('general.year',2)}}</span>
                                </div>
                            </div>
                            <div class="form-group">
            ...
            <div class="panel panel-white">
                <div class="panel-body">
                    ...
                    <div class="tab-content">
                       ...
                       href="{{url('saving/'.$saving->id.'/transfer/create')}}">{{trans_choice('general.transfer',1)}}
                                </a>
                                @endif
                            </div>
