                ...
                <table id="data-table" class="table table-bordered table-condensed table-hover">
                    ...
                    @foreach($data as $key)
                        <tr>
                            ...
                            <td>
                              {{ number_format($total = \App\Models\ProductCheckoutItem::where('product_check_out_id',$key->id)->sum('total_cost'),2) }}
                            </td>
                            <td>
                                {{ number_format($paid = \App\Models\ProductPayment::where('product_check_out_id',$key->id)->sum('amount'),2) }}

                            </td>
                            <td>
                                {{ number_format($total -$paid, 2) }}
                            </td>
                            <td><a href="{{ url('check_out/'.$key->id.'/show') }}">View/Print</a> </td>
