...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        $data = User::with('roles')->orderByDesc('last_login')->get();
    ...
    public function store(Request $request)
    {
        ...
        $sacco = Sentinel::getUser()->sacco_id;
        if ($validator->fails()) {
            ...
            $credentials = [
                ...
                'phone' => $request->phone,
                'sacco_id' =>Sentinel::getUser()->sacco_id
            ];
...
//        $role = DB::table('role_users')->where('user_id',Sentinel::getUser()->id)->first();
//        $perms
        $permissions = Permission::where('parent_id', 0)->get();
        foreach ($permissions as $permission) {
            array_push($data, $permission);
    ...
    public function storeRole(Request $request)
    {
        ...
        $role->sacco_id = Sentinel::getUser()->sacco_id;
