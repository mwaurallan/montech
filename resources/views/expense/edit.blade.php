...
@section('content')
    <div class="panel panel-white">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                {!! Form::label('account_to','Account To',array('class'=>' control-label')) !!}
                {!! Form::select('account_to',$chart_expenses,$expense->account_to, array('class' => 'form-control select2','placeholder'=>"",'required'=>'required')) !!}
            </div>
            <div class="form-group">
