...
<head>
    ...
    <meta name="Alex" content="Open Sacco" />
...
{{--                        <li><a href="{{ url('client/register') }}"><div>Register</div></a></li>--}}
                        <li><a href="{{ url('admin') }}"><div>Admin Login</div></a></li>
                        @if(\App\Models\Setting::where('setting_key', 'allow_client_login')->first()->setting_value == 1)
                            <li><a href="{{ url('client') }}"><div>Client Login</div></a></li>
                            @endif
                    </ul>
        ...
        <div class="slider-parallax-inner">
            ...
            <div class="swiper-container swiper-parent">
                <div class="swiper-wrapper">
                        <div class="swiper-slide dark"  style="background-image: url('img/logo1.jpeg');background-size: auto;">
                            <div class="container clearfix">
                                <div class="slider-caption slider-caption-center">
                                    ...
                                    <p class="d-none d-sm-block" data-caption-animate="fadeInUp" data-caption-delay="200">Our Commitment to provide customized financial solutions to individuals and corporates is our driving force,Raising bussiness from startups to world leading brands is our vision,we endevour to increase our members financial capacity by not only providing financial solutions but also bulding capacity in such fields as farming,business and individual enterprises</p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="content-wrap">
            ...
            <div class="container clearfix">
                ...
                <div class="heading-block title-center page-section" id="section-features">
                    ...
                    <span>To empower and transform members
through affordable financial solutions.</span>
                </div>
                <div class="heading-block title-center page-section" id="section-features">
                    <h2>JINAWIRI LENDING PHILOSOPHY</h2>
                    <span> interest is 1%p.m.</span>
                    <p> Loan products: business loans, emergency loans, education loans, kilimo loans, asset finance, project finance..</p>
                </div>
                <div class="heading-block title-center page-section" id="section-features">
                    <h2>How to register</h2>
                    <span>HOW TO REGISTER AS A JINAWIRI MEMBER.
Go to;
1. Mpesa menu
2. Lipa na mpesa - Paybill Option
4. Paybill Number - 400222
5.Account Number - 302280#Your Name
6. Amount
7.Mpesa pin.....then send.</span>
                </div>
                ...
                <div class="container clearfix">
                    ...
                    <div class="col_one_third">
                        <div class="feature-box fbox-small fbox-plain" data-animate="fadeIn" data-delay="600">
                            ...
                            <p>We provide an avenue where our clients can create a culture of monthly savings thereby giving them an opportunity to increase their financial base.</p>
                        </div>
                    </div>
                    ...
                    <div class="col_one_third">
                        <div class="feature-box fbox-small fbox-plain" data-animate="fadeIn" data-delay="800">
                            ...
                            <p>Customized loan products which are specifically tailored to meet individuals requirements,with a higly competitive interest rate of 12% Reducing Balance.</p>
                        </div>
                    </div>
                ...
                <div class="col_two_third">
                    ...
                    <div class="col_one_third col_last" style="width:28%;margin-top: 20px;">
                        ...
                        <div class="widget widget_links clearfix">
                            <h4>Contacts</h4>
                            <ul class="">
                                <li><span><i class="icon-mail"></i>  </span> 
jinawirisacco@gmail.com</li>
{{--                                <li><span><i class="icon-mail"></i>  </span> </li>--}}
                                <li><span><i class="icon-mobile"></i>  </span> 0796517475</li>
                              <li><span><i class="icon-mobile"></i>  </span>  </li>
                                <li><span><i class="icon-mobile"></i>  </span> www.jinawirisacco.co.ke </li>
                            </ul>
                        </div>
                ...
                <div class="col_one_third col_last" style="margin-top: 20px;">
                    <div class="widget subscribe-widget clearfix" >
                        <h4>Location</h4>
                        <ul>
                            <li>Life Church Limuru)</li>
                            <li>Behind Naivas Supermarket</li>
                            <li>Limuru Town</li>
        ...
        <div id="copyrights">
            ...
            <div class="container clearfix">
                ...
                <div class="col_half">
                    Copyright © {{ config('app.name') }}.   |   <a href="{{ url('/') }}" target="_self" style="color:#626464;">{{ config('app.name') }}</a>
                </div>
