...
@section('title')
    {{trans_choice('general.add',1)}} Sms Template
@endsection
@section('content')
    <div class="panel panel-white">
        <div class="panel-heading">
            <h6 class="panel-title">{{trans_choice('general.add',1)}} Sms Template</h6>

            <div class="heading-elements">

            </div>
        </div>
        {!! Form::open(array('url' => url('template/store'), 'method' => 'post', 'class' => 'form-horizontal')) !!}
        <div class="panel-body">
            <div class="form-group">
                {!! Form::label('event',trans_choice('general.name',1)." *",array('class'=>'col-sm-2 control-label')) !!}
                <div class="col-sm-10">
                    {!! Form::text('event',null, array('class' => 'form-control', 'placeholder'=>"",'required'=>'required')) !!}
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    {!! Form::select('status',['1'=>trans_choice('general.yes',1),'0'=>trans_choice('general.no',2)],'1', array('class' => 'form-control', 'id'=>"active",'required'=>'required')) !!}
                </div>
            </div>
        </div>
        <!-- /.panel-body -->
