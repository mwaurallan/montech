...
<div class="page-container">
    <div class="page-content">
        ...
        <div class="content-wrapper">
            <div class="page-header page-header-default hidden-print">
...
<script src="{{asset("assets/themes/limitless/js/plugins/pickers/pickadate/legacy.js")}}"></script>
<script src="{{asset("assets/themes/limitless/js/plugins/pickers/pickadate/picker.js")}}"></script>
<script src="{{asset("assets/themes/limitless/js/plugins/pickers/pickadate/picker.date.js")}}"></script>
<script src="{{asset("assets/themes/limitless/js/plugins/pickers/pickadate/picker.time.js")}}"></script>
