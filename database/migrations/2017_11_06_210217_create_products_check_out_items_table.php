...
class CreateProductsCheckOutItemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('product_check_out_items', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::drop('product_check_out_items');
    }
}
