...
@section('content')
    <div class="panel panel-white">
        <div class="panel-heading">
            <h6 class="panel-title">{{trans_choice('general.edit',1)}} {{trans_choice('general.borrower',1)}}</h6>
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        @if(!is_null($borrower->files))
                            @php $files = unserialize($borrower->files); @endphp
                        @if(is_array($files))
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-4">
                        ...
                        {!! Form::text('username',$borrower->username, array('class' => 'form-control', 'placeholder'=>"",'autocomplete'=>'off')) !!}
                    </div>
                    <div class="col-md-4">
                        {!! Form::label('password',trans_choice('general.password',1),array('class'=>'')) !!}
                        {!! Form::password('password', array('class' => 'form-control', 'placeholder'=>"",'autocomplete'=> 'off')) !!}
                    </div>
                    <div class="col-md-4">
                        {!! Form::label('repeatpassword',trans_choice('general.repeat_password',1),array('class'=>'')) !!}
                        {!! Form::password('repeatpassword', array('class' => 'form-control', 'placeholder'=>"",'autocomplete'=>'off')) !!}
                    </div>
                </div>
            </div>
            <div class="form-group">
